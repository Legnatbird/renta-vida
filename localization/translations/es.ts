export default {
  ...
  goals: {
    ...
    selectPlanDescription: 'Selecciona un plan de renta voluntaria que se ajuste a tus necesidades financieras.',
    paymentInformation: 'Información de Pago',
    pendingPayment: 'Pago Pendiente',
    dueBy: 'Fecha límite',
    noPaymentDue: 'No hay pagos pendientes en este momento.',
    nextPayment: 'El próximo pago vence el',
