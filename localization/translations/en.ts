export default {
  ...
  goals: {
    ...
    month: 'month',
    selectRentalPlan: 'Select Rental Plan',
    ...
    planWeaknesses: 'Weaknesses',
    planA: 'Plan A: High Contribution',
    planB: 'Plan B: Balanced Approach',
    ...
    selectPlanDescription: 'Select a voluntary rental plan that suits your financial needs.',
    paymentInformation: 'Payment Information',
    pendingPayment: 'Pending Payment',
    dueBy: 'Due by',
    noPaymentDue: 'No pending payments at this time.',
    nextPayment: 'Next payment will be due on',
